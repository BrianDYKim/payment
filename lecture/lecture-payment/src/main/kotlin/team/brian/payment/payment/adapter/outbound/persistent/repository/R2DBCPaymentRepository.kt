...
class R2DBCPaymentRepository(
    ...
    companion object {
        ...
        val INSERT_PAYMENT_ORDERS_QUERY = fun(valueClauses: String) =
            """
    ...
    private fun insertPaymentOrders(
        ...
        val valueCluases =
            paymentEvent.paymentOrders.joinToString(", ") { paymentOrder ->
        ...
        return databaseClient.sql(INSERT_PAYMENT_ORDERS_QUERY(valueCluases))
            .fetch()
            .rowsUpdated()
    }

    private fun selectPaymentEventId(): Mono<Long> =
